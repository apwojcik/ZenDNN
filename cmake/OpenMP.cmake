...
if(ZENDNN_DPCPP_HOST_COMPILER STREQUAL "DEFAULT")
...
if(ZENDNN_CPU_THREADING_RUNTIME MATCHES "OMP")
    if(ZENDNN_WITH_SYCL AND ZENDNN_DPCPP_HOST_COMPILER MATCHES "g\\+\\+")
    ...
    elseif(OpenMP_CXX_FOUND)
        ...
        set(ZENDNN_CPU_THREADING_RUNTIME "SEQ")
    endif()
else()
