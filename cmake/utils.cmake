...
function(add_zendnn_test name command)
    add_test(${name} ${ZENDNN_TARGET_EMULATOR} ${command} ${ARGN})
endfunction()
...
macro(append_host_compiler_options var opts)
    if(NOT ZENDNN_DPCPP_HOST_COMPILER STREQUAL "DEFAULT")
